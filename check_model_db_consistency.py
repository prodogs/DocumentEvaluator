...
def compare_schemas():
    ...
    print("🔍 Checking consistency between SQLAlchemy models and database schema...\n")
    ...
    for table in sorted(common_tables):
        ...
        if not missing_in_db_cols and not missing_in_model_cols:
            print(f"  ✅ All columns consistent")
    ...
    return len(inconsistencies) == 0 and not missing_in_db and not missing_in_models
