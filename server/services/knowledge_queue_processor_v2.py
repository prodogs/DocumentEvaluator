"""
KnowledgeDocuments Queue Processor V2

This service processes batches through BatchService instead of direct database access.
...
class KnowledgeQueueProcessorV2:
    ...
    def start(self):
        ...
        logger.info("KnowledgeQueueProcessor V2 started - using BatchService coordination")
    ...
    def stop(self):
        ...
        logger.info("KnowledgeQueueProcessor V2 stopped")
...
# Global instance
knowledge_queue_processor_v2 = KnowledgeQueueProcessorV2()


def start_queue_processor():
    """Start the global queue processor"""
    knowledge_queue_processor_v2.start()
    

def stop_queue_processor():
    """Stop the global queue processor"""
    knowledge_queue_processor_v2.stop()
    

def get_queue_processor_status():
    """Get status of the global queue processor"""
    return knowledge_queue_processor_v2.get_status()